...
public class Drawer
{
    ...
    public void draw(String sourceName, Piece AST)
    {
        ...
        proj18AhnSlagerZhao.bantam.treedrawer.LayoutVisitor layout = new LayoutVisitor(fontMetrics);
        proj18AhnSlagerZhao.bantam.treedrawer.DrawingTree theDrawing = (DrawingTree) AST.accept(layout);
