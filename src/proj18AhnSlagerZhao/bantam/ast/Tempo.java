...
/**
 * The <tt>Tempo</tt> class represents a tempo declaration.
 * It contains the name of the tempo.
 *
 * @see ASTNode
 * @see Expr
 */
public class Tempo extends Member {
    /**
     ...
     * @param tempo    the name of the tempo
     */
    public Tempo(int lineNum, String tempo) {
        super(lineNum);
        this.tempo = tempo;
    }
