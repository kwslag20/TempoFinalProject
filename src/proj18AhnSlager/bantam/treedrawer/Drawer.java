...
package proj18AhnSlager.bantam.treedrawer;
...
public class Drawer
{
    ...
    public void draw(String sourceName, Piece AST)
    {
        ...
        proj18AhnSlager.bantam.treedrawer.LayoutVisitor layout = new LayoutVisitor(fontMetrics);
        proj18AhnSlager.bantam.treedrawer.DrawingTree theDrawing = (DrawingTree) AST.accept(layout);
